...
"""
Generate MapLibre SDF glyph PBF files for Noto Sans KR Bold.
...
Usage: python3 scripts/generate-noto-bold-pbf.py
"""
...
OUT_DIR  = os.path.join(ROOT, "assets/fonts/maplibre/Noto_Sans_KR_Bold")
FONT_SRC = "/Users/dev/Downloads/Noto_Sans_KR/static/NotoSansKR-Bold.ttf"
...
def main():
    print("=== Noto Sans KR Bold PBF Generator ===")
    ...
    for i, (start, end) in enumerate(needed):
        ...
        pbf = encode_pbf("Noto Sans KR Bold", f"{start}-{end}", glyphs)
